package TestNG_Multiple_Suites_sanity;
...
public class TestBase {
	...
	public TestBase() throws Exception {
		...
		FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+"/src/test/java/TestNG_Multiple_Suites_sanity/config.properties");
		prop.load(ip);
